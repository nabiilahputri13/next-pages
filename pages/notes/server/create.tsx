...
export default function NotesServerCreate() {
    ...
    const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log('An unexpected error happeneda: ', error)
        } finally {
            SetIsLoading(false)
        }
    }
        ...
        <div className="container mx-auto p-4">
            ...
            <h2 className="text-xl font-semibold mb-4">
                ...
                <div>
                    ...
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 docus:border-blue-500 p-2"
                    />
                    {error && typeof error === 'object' && error.errors && (
