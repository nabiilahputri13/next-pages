  ...
  return (
    <div className="p-8 max-w-xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4" encType="multipart/form-data">
        ...
        <div>
          <label className="text-l font-semibold">Workshop label</label>
          <input
            type="text"
            placeholder="Workshop Label"
            value={label}
        ...
        <div>
          <label className="text-l font-semibold">Workshop place</label>
          <input
            type="text"
            placeholder="Workshop Place"
            value={place}
        ...
        <div>
          <label className="text-l font-semibold">Workshop description</label>
          <textarea
        ...
        <div>
          <label className="text-l font-semibold">Workshop price</label>
          <input
            type="number"
            placeholder="Price"
            value={price}
        ...
        <div>
          <label className="text-l font-semibold">Workshop date</label>
          <input
            type="datetime-local"
            value={date}
        ...
        <div>
          ...
          >
            {previewUrl ? (
              <img src={previewUrl} alt="Preview" className="w-full h-70 object-cover" />
            ) : (
              <div className="w-full h-70 bg-gray-300 flex items-center justify-center">
                <span className="text-3xl text-white">+ Add Image</span>
              </div>
            )}
            <p className="text-sm text-gray-600 mt-2">{image ? image.name : ''}</p>
          </div>
          <input
            id="imageInput"
            type="file"
